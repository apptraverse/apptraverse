...
if(NOT RUNTIME_V0)
  message(FATAL_ERROR "RUNTIME_V0 is not set")
endif()
if(NOT RUNTIME_V1)
...
if(NOT distiller_result EQUAL 0)
  message(FATAL_ERROR
    "event state version distiller v0 failed with code ${distiller_result}")
endif()

execute_process(
  COMMAND "${RUNTIME_V0}" "${WRITABLE_ROOT}" "${BASE_ROOT}"
  RESULT_VARIABLE runtime_v0_result
)
if(NOT runtime_v0_result EQUAL 0)
  message(FATAL_ERROR
    "event state version runtime v0 failed with code ${runtime_v0_result}")
endif()
...
if(NOT runtime_v1_result EQUAL 0)
  message(FATAL_ERROR
    "event state version runtime v1 failed with code ${runtime_v1_result}")
endif()
...
if(NOT rollback_v0_result EQUAL 0)
  message(FATAL_ERROR
    "event state version rollback v0 failed with code ${rollback_v0_result}")
endif()
